...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_plumber_blog_advertisement_banner(); ?>
			...
			if( class_exists( 'woocommerce' ) ) {
				// Blog Catalogues
				get_template_part( 'template-parts/catalogues/catalogues' ); 

				// Blog Renowned Brands
				get_template_part( 'template-parts/renowned-brands/renowned-brands' );
			}
			?>
			
			<!--Blog Grand Events-->
			<?php get_template_part( 'template-parts/grand-events/grand-events' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-plumber' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-plumber' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-plumber' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-plumber' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-plumber' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
